package com.example.survivegame_reveresedeng;
    ...
    private void initViews() {
        this.menu_BTN_start.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(!isOnline()){
                    Toast.makeText(Activity_Menu.this, "No Internet connection!", Toast.LENGTH_LONG).show();
                }
                else if (menu_EDT_id.getText().toString().length()!=9){
                    Toast.makeText(Activity_Menu.this, "ID should be 9 numbers", Toast.LENGTH_LONG).show();
                }
                else{
